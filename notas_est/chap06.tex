...
\section{Introduci\'on a las Redes Neuronales}
...
%	\frametitle{Feed forward neural network}
	...
	\begin{figure}[H]
		\centering
		\textbf{}\par\medskip
		\fcolorbox{green}{blue}{\includegraphics[width=\linewidth,scale=0.5]{NN}}
...
%
%\foreach \l [count=\x from 0] in {Capa de entrada, Capa Oculta, Salida}
...
%\begin{frame}
%	\frametitle{Feed forward neural network}
	\subsubsection{\textbf{Comparaci\'on de Pron\'ostico}}
...
%	\vspace{4mm}	
	...
	\begin{figure}[H]
		\centering
		\textbf{}\par\medskip
		\fcolorbox{green}{blue}{\includegraphics[width=\linewidth,scale=0.5]{nnar}}
		\caption{}\label{fig6_2}
%		\includegraphics[scale=0.25]{nnar}
	\end{figure}
...
%	\vspace{4mm}	
	...
	\begin{figure}[H]
		\centering
		\textbf{}\par\medskip
		\fcolorbox{green}{blue}{\includegraphics[width=\linewidth,scale=0.5]{ann}}
		\caption{}\label{fig6_3}
%		\includegraphics[scale=0.35]{ann}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\textbf{}\par\medskip
		\fcolorbox{green}{blue}{\includegraphics[width=\linewidth,scale=0.5]{arima}}
		\caption{}\label{fig6_4}
%		\includegraphics[scale=0.35]{arima}
	\end{figure}
...
\pagebreak\section{Support Vector Machines (SVM)}
...
%\begin{frame}
%	\frametitle{Support Vector Machines (SVM)}
%	\textbf{Definiciones del modelo - Estructura de la SVM}
\subsection{Definiciones del modelo - Estructura de la SVM}
...
\subsection{Definiciones del modelo - Funciones de perdida}
...
%\begin{frame}
%	\frametitle{Feed forward neural network}
\subsubsection{\textbf{Ejemplo 3 - Calculando el beta de Mastercard } }
...
%	\textbf{Ejemplo 3 - Calculando el beta de Mastercard } 
	...
	\begin{figure}[H]
		\centering
		\textbf{}\par\medskip
		\fcolorbox{green}{blue}{\includegraphics[width=\linewidth,scale=0.5]{svm_versus_ols}}
		\caption{}\label{figxx}
